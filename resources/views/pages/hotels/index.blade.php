    ...
    <div>
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-pink-500 font-medium mb-2">{{ $hotel->category }}</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="text-right">
                                    <span class="text-lg font-bold text-pink-600">{{ $hotel->price_range }}</span>
                                </div>
                            </div>
        ...
        <div class="bg-gradient-to-r from-pink-100 to-purple-100 py-16">
            <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-pink-600 mb-4">Ready for Your Dream Vacation?</h2>
                <p class="text-lg text-pink-700 mb-8">
                    Book your stay at one of these magnificent hotels and experience the beauty of Hurghada.
                </p>
